...
class Post extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * Return a ticket post from given post id.
     *
     * @param Action $action
     * @param null $postId
    ...
    public function prepareResultPost(Action $action, $postId = null)
    {
        ...
        $resultPage->addHandle('ticket_post_view');

        // This will generate a layout handle like: ticket_post_view_id_1
        // giving us a unique handle to target specific ticket posts if we wish to.
        ...
        $this->_eventManager->dispatch(
            'jhkinfotech_ticket_post_render',
