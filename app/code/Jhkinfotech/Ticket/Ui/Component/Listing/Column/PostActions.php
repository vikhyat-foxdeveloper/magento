...
namespace Jhkinfotech\Ticket\Ui\Component\Listing\Column;
...
{
    /** Url path */
    const BLOG_URL_PATH_EDIT = 'ticket/post/edit';
    const BLOG_URL_PATH_DELETE = 'ticket/post/delete';
    const BLOG_URL_PATH_DETAIL = 'ticket/post/detail';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['post_id'])) {
                    ...
                    $item[$name]['detail'] = [
                        'href' => $this->urlBuilder->getUrl(self::BLOG_URL_PATH_DETAIL, ['post_id' => $item['post_id']]),
                        'label' => __('Reply')
                    ];
                    $item[$name]['delete'] = [
